...
<div class="main-content">
					...
					<div class="page-content">
							<div class="row">
									...
									<form class="form-horizontal" role="form" action="{{url('call/store')}}" method="post">
                                        @csrf
                                    <div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">访问人</label>

										<div class="col-sm-9">
											<input type="input" id="form-field-2"  name="call_name"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="input" id="form-field-2" name="call_site"/>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-sm-9">
                                          <textarea name="call_desc" id='form-field-2' cols="30" rows="10"></textarea>
										</div>
                                    </div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" class="time" placeholder="请选择时间" name="call_time"/>
										</div>
									</div>
                                    <div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" class="abc" name="next_time" placeholder="请选择下次访问时间"/>
										</div>
									</div>
